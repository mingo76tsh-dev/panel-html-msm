// sw.js — HSM v7 Móvil — v1.3.3 (scope: /panel-html-msm/)
...
// ===== Helpers de rutas según el scope real (GitHub Pages subcarpeta)
...
self.addEventListener('fetch', (event) => {
  ...
  // Recursos de otro origen: dejar pasar; cachear sólo imágenes básicas
  if (!sameOrigin(url)) {
